package com.redhat.rule.runner;
...
import com.redhat.rule.listener.RulesAgendaListener;
...
public class RulesRunner {
	...
	public void initialisation(String fileName) {
		path = System.getProperty("user.dir") + "/src/main/resources/com/redhat/rules/";
		...
		resource.setSourcePath("com.redhat.rules." + fileName);
